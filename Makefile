.PHONY: help install install-node install-python compile ganache migrate backend frontend dev test test-frontend test-backend test-contracts build lint clean docker-up docker-down demo
...
help:
	...
	@echo "  make demo           - Launch full demo (Ganache, migrations, backend, frontend in 1 command)"
