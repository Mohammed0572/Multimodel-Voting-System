  ...
  const adminLogin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        updateStatus(
          `Failed: ${errData.detail || "Invalid credentials."}`,
          "error",
        );
        setIsProcessing(false);
      }
      ...
      <div className="w-full max-w-md overflow-hidden bg-white shadow-2xl shadow-black/5 rounded-2xl border border-gray-100">
        ...
        <div className="p-6 sm:p-8 space-y-5 fade-in">
          <div className="flex flex-col gap-1">
            <label htmlFor="adminId" className="font-medium text-sm">
              {t("adminlogin.id_label")}
            </label>
            <input
              id="adminId"
              type="text"
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="adminPassword" className="font-medium text-sm">
              Password
            </label>
